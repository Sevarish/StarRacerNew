...
public class UI : MonoBehaviour {
    ...
    public string[] planetName = { "Venus", "Mars", "Mercury", "Jupiter", "Saturn", "Uranus", "Neptune"};
     string[] planetInfo = {
        "Venus was named after the Goddess of love and beauty and is after the sun the brightest planet in our solarsystem."
            , "Mars is named after the Romanian God of war because of it's red appearance. The red color is caused by the oxidated iron on the surface."
            , "Mercury is our fastest planet. It is named after the messenger of the Romanian Gods, because it goes arround the sun in 88 days."
            , "Jupiter is the biggest planet in our solarsystem, and is therefore named after the Romanian king."
            ...
            , "Neptune is named after the Romanian God of sea cause of its blue color. Neptune has 8 to 10 moons."
   };
	...
	void Update () {
        ...
        distanceUpText.text = kmUpString + "\n";
        planetInfoText.text = planetInfo[distanceCount];
